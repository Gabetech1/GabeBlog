   ...
   $the_post_id = $_GET['p_id'];
        ...
        <?php
          ...
          if(isset($_POST['create_comment'])){
            ...
            if(!empty($comment_author) && !empty($comment_email) && !empty($post_content) ){
               ...
               $query_2 = "UPDATE post SET post_comment_count = post_comment_count + 1 ";
               $query_2 .= "WHERE post_id = $the_post_id";
   
               $update_comment_count = mysqli_query($connection, $query_2);
